...
def train(num_epochs, batch_size, device, hidden_nodes, lr, weight_decay, model_name):
    ...
    exp_name = f"{model_name}__ep{num_epochs}_bs{batch_size}_hn_{hidden_nodes}_lr{lr:.0e}_wd{weight_decay:.0e}_{date_str}_dataset16_1"
...
if __name__ == "__main__":
    ...
    train(num_epochs=30, batch_size=1, device=device, hidden_nodes=256, lr=0.0001, weight_decay=0.0005, model_name="classifier")